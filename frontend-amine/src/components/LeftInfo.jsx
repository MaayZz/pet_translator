const STACK = [
  ...
  { name: "Large Language Model", tech: "Llama 3.2 1B (LoRA)", desc: "Fine-tuned via unsloth on 5K+ synthetic pet phrases. Runs on llama.cpp backend" },
  ...
  return (
    <aside className="side-panel left">
      <div className="panel-header">
        ...
        <p className="badge">ML01 — Fun & Experimental</p>
        <p className="desc">
